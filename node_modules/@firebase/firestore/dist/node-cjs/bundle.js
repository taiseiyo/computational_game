...
var LoadBundleTask = /** @class */ (function () {
    function LoadBundleTask() {
        ...
        this._taskCompletionResolver = new databaseD2f5a4c2.Deferred();
        this._lastProgress = {
            taskState: 'Running',
            totalBytes: 0,
            totalDocuments: 0,
...
function loadBundle(db, bundleData) {
    ...
    databaseD2f5a4c2.firestoreClientLoadBundle(databaseD2f5a4c2.ensureFirestoreConfigured(db._delegate), db._databaseId, bundleData, resultTask);
    return resultTask;
}
function namedQuery(db, name) {
    return databaseD2f5a4c2.firestoreClientGetNamedQuery(databaseD2f5a4c2.ensureFirestoreConfigured(db._delegate), name).then(function (namedQuery) {
        if (!namedQuery) {
            return null;
        }
        return new databaseD2f5a4c2.Query$1(db, new databaseD2f5a4c2.Query(db._delegate, null, namedQuery.query));
    });
}
/**
 * @license
...
registerBundle(databaseD2f5a4c2.Firestore);
