 ...
 * limitations under the License.
 */
const LOG_TAG$6 = 'MemoryPersistence';
/**
...
class MemoryPersistence {
    ...
    runTransaction(action, mode, transactionOperation) {
        logDebug(LOG_TAG$6, 'Starting transaction:', action);
...
class FirestoreClient {
    ...
    asyncQueue, databaseInfo) {
        ...
        this.credentials.setChangeListener(user => {
            logDebug(LOG_TAG$b, 'Received user=', user.uid);
...
async function setOfflineComponentProvider(client, offlineComponentProvider) {
    ...
    logDebug(LOG_TAG$b, 'Initializing OfflineComponentProvider');
...
async function setOnlineComponentProvider(client, onlineComponentProvider) {
    ...
    logDebug(LOG_TAG$b, 'Initializing OnlineComponentProvider');
    const configuration = await client.getConfiguration();
...
async function ensureOfflineComponents(client) {
    if (!client.offlineComponents) {
        logDebug(LOG_TAG$b, 'Using default OfflineComponentProvider');
...
async function ensureOnlineComponents(client) {
    if (!client.onlineComponents) {
        logDebug(LOG_TAG$b, 'Using default OnlineComponentProvider');
...
exports.firestoreClientGetNamedQuery = firestoreClientGetNamedQuery;
exports.firestoreClientLoadBundle = firestoreClientLoadBundle;
exports.setLogLevel$1 = setLogLevel$1;
//# sourceMappingURL=database-5c2af034-9a7351f3.js.map
