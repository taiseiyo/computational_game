 ...
 */ declare class Gu extends O {
    static Rd(t: any, e: any, n: any): Gu;
    static Ad(t: any, e: any, n: any): Gu;
    ...
    get(t: any): Promise<Yu>;
    withConverter(t: any): Gu;
}
declare function Ku(t: any): void;
/** Immutable class holding a blob (binary data) */ export class L extends O {
    static fromBase64String(t: any): L;
    static fromUint8Array(t: any): L;
    constructor(t: any);
    toBase64(): any;
    toUint8Array(): any;
    isEqual(t: any): any;
 ...
 */ declare class Wu extends O {
    constructor(t: any, e: any);
    zf: any;
    get(t: any): any;
    set(t: any, e: any, n: any): Wu;
    update(t: any, e: any, n: any, ...s: any[]): Wu;
    delete(t: any): Wu;
}
declare class Xu extends Yu {
    constructor(t: any, e: any);
}
declare class Yu extends O {
    constructor(t: any, e: any);
    zf: any;
    get ref(): Gu;
    get id(): any;
...
declare class Zu extends O {
    constructor(t: any, e: any);
    firestore: any;
    Hf: Qu;
    where(t: any, e: any, n: any): Zu;
    orderBy(t: any, e: any): Zu;
    limit(t: any): Zu;
    limitToLast(t: any): Zu;
    startAt(...t: any[]): Zu;
    startAfter(...t: any[]): Zu;
    endBefore(...t: any[]): Zu;
    endAt(...t: any[]): Zu;
...
declare class nh extends Zu {
    constructor(t: any, e: any);
    get id(): any;
    get path(): any;
    get parent(): Gu | null;
    doc(t: any): Gu;
    add(t: any): Promise<Gu>;
}
declare const Xa: -1;
/**
 ...
 */
declare class Za extends _i {
    /** @hideconstructor */
    constructor(t: any, e: any);
    Mf: Ya;
}
declare function ch(t: any, e: any): oh;
declare class eh extends O {
    constructor(t: any, e: any);
    zf: any;
    get query(): Zu;
    get metadata(): any;
...
/** A CredentialsProvider that always yields an empty token. */ declare class q {
    /**
...
declare class ks {
    ...
    si(): void;
    cancel(): void;
    /** Returns a random value in the range [-currentBaseMs/2, currentBaseMs/2] */ ei(): number;
}
/**
 * @license
 * Copyright 2017 Google LLC
...
declare class Fs {
     ...
     */ static qs(t: any, e: any, n: any, s: any, i: any): Fs;
     ...
     * createAndSchedule().
     */ start(t: any): void;
    Us: NodeJS.Timeout | null | undefined;
    /**
 ...
 */ declare class _t {
    static Lt(t: any): _t;
    static $t(t: any): _t;
    static At(t: any, e: any): 0 | 1 | -1;
    static qt(t: any): boolean;
    /**
    ...
    constructor(t: any);
    path: any;
    /** Returns true if the document is in the specified collectionId. */ Bt(t: any): boolean;
    isEqual(t: any): boolean;
    toString(): any;
}
/**
...
export { Gu as G, Ku as K, Uu as U, Wu as W, Xu as X, Yu as Y, Zu as Z, nh as a, Xa as b, Za as c, ch as d, eh as e, ah as f, ih as i, ju as j, na as n, ot as o, qu as q, rh as r };
